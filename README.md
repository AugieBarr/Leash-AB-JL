...
- Governance layer complete — audit ledger (Ed25519 hash-chain), scope guard, capability ACLs, sealed bundle + offline verify CLI. **28/28 tests green** (incl. tamper-detection, the cap-never-exceeded scale invariant, and fail-closed scoping).
