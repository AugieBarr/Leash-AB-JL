...
def build_swarm(eng):
    """Build all ten Band agents wired to the shared Engagement."""
    return [
        ...
        build_agent("leash-injection-tester", INJECTION_TESTER, injection_tools(eng)),
        build_agent("leash-data-sentinel", DATA_SENTINEL, exposure_tools(eng)),
